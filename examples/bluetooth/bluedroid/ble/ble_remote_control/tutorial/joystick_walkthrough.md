...
* `main.c` : Entry point, demonstrate initialization and the main getting user input and sending hid report task
* `joystick_input.c` : Demonstrate initialization and tearing down of analog and digital input, for the joystick and buttons respectively
